  ...
  return (
    <div className="-mt-[6rem]">
      ...
      <motion.p
        ...
        i am experienced in Javascript, ReactJS, Nextjs, wordpress, Typescript, tailwind, Git and more.
        Building responsive, interactive, friendly UI and simply user experience has been my key set of values
      </motion.p>
